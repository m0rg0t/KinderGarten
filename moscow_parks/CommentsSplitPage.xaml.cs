...
namespace moscow_parks
{
    ...
    /// </summary>
    public sealed partial class CommentsSplitPage : moscow_parks.Common.LayoutAwarePage
    {
        public CommentsSplitPage()
        {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            else
            {
                ...
                {
                    // TODO: Вызов метода this.itemsViewSource.View.MoveCurrentTo() с выбранным
